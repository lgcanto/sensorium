...
namespace Sensorium
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("SensoriumPolicy", builder =>
                {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Sensorium API", Version = "v1" });
            });
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, PostgreDbContext dataContext)
        {
